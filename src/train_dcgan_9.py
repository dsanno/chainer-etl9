...
from net import Generator10 as Generator, Discriminator10 as Discriminator
...
#            loss_dis = train_dis(gen, dis, optimizer_gen, optimizer_dis, x_batch, gpu_device)
            ...
            if i % image_save_interval == 0:
                ...
                if out_image_dir != None:
                    ...
                    image = ((1 - cuda.to_cpu(data)) * 256).clip(0, 255).astype(np.uint8).reshape((10, 10, 96, 96)).transpose((0, 2, 1, 3)).reshape((10 * 96, 10 * 96))
